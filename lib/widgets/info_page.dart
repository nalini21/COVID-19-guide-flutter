    ...
    return Scaffold(
      ...
      body: ListView(children: <Widget>[
        ...
        Container(
              ...
              child: Column(children: <Widget>[
                ...
                Container(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(fontSize: 20, color: Colors.purple[800], fontFamily: 'Quicksand', fontWeight: FontWeight.bold),
                  ),
                ),
              ]),
            )),
            Container(
              color: Colors.grey[350],
              padding: EdgeInsets.fromLTRB(60.w,20.h,0,20.h),
              child: Text('source: https://www.healthline.com/health/coronavirus-covid-19',
